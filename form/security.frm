...
Begin VB.Form frm_security 
   ...
   Begin Project1.jcbutton cmd_home 
      ...
      ForeColor       =   5066498
      HandPointer     =   -1  'True
      Picture         =   "security.frx":617A
      PictureHover    =   "security.frx":1F9EC
      pictureSize     =   3
      CaptionAlign    =   0
   End
   Begin Project1.jcbutton cmd_visual 
      ...
      ForeColor       =   5066498
      HandPointer     =   -1  'True
      Picture         =   "security.frx":3925E
      PictureHover    =   "security.frx":3AF68
      pictureSize     =   3
      CaptionAlign    =   0
   End
   Begin Project1.jcbutton cmd_security 
      ...
      Value           =   -1  'True
      HandPointer     =   -1  'True
      Picture         =   "security.frx":3CC72
      PictureHover    =   "security.frx":3E97C
      pictureSize     =   3
      CaptionAlign    =   0
   End
   Begin Project1.jcbutton cmd_about 
      ...
      ForeColor       =   5066498
      HandPointer     =   -1  'True
      Picture         =   "security.frx":4416E
      PictureHover    =   "security.frx":45E78
      pictureSize     =   3
      CaptionAlign    =   0
   End
   Begin Project1.jcbutton cmd_winfunction 
      ...
      ForeColor       =   5066498
      HandPointer     =   -1  'True
      Picture         =   "security.frx":47B82
      PictureHover    =   "security.frx":4988C
      pictureSize     =   3
      MaskColor       =   16777215
      CaptionAlign    =   0
   End
   ...
   Begin Project1.jcbutton cmd_optimize 
      ...
      ForeColor       =   5066498
      HandPointer     =   -1  'True
      Picture         =   "security.frx":4B596
      PictureHover    =   "security.frx":A6E40
      pictureSize     =   3
      UseMaskCOlor    =   -1  'True
      MaskColor       =   16777215
      CaptionAlign    =   0
...
Private Sub Form_Load()
    ...
    navigasi_fungsi frm_security, -0, False
End Sub
...
ganti_form frm_home, frm_security, Me.Left, Me.Top
End Sub

Private Sub cmd_visual_Click()
ganti_form frm_visual1, frm_security, Me.Left, Me.Top
End Sub

Private Sub cmd_security_Click()
cmd_security.Value = True
End Sub

Private Sub cmd_winfunction_Click()
ganti_form frm_winfunction, frm_security, Me.Left, Me.Top
End Sub

Private Sub cmd_optimize_Click()
ganti_form frm_optimize, frm_security, Me.Left, Me.Top
End Sub

Private Sub cmd_about_Click()
ganti_form frm_about, frm_security, Me.Left, Me.Top
End Sub

Private Sub apply_Click()
pilih_apply_fungsi frm_security
End Sub

Private Sub cmd_nav_fungsi_Click(Index As Integer)
navigasi_fungsi frm_security, Index, True
End Sub

Private Sub Chk_opt_Click(Index As Integer)
pilih_fungsi frm_security, Index
End Sub
